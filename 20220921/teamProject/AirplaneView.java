...
import teamProject.mypage.MypageController;
import teamProject.mypage.MypageVO;
...
public class AirplaneView {
	...
	private MypageController mypageController = MypageController.getInstance();
	...
	public void join() throws Exception {
		...
		int insertJoin = joinController.insertJoin(new JoinVO(memId, password, memName, memBir, account, bank));
		if (insertJoin > 0) {
	 ...
	 */
	public int menu() {
		System.out.println("\n1. 예약   2. 예약취소   3. 예약확인   4. 로그아웃   5. 회원정보   0. 종료 ");
...
//		}
	...
	public void getCancelNumber() throws Exception {
		...
		System.out.printf("가격\t\t: %d\n계좌번호\t: %s\n은행\t\t: %s\n취소 후 마일리지: %s점\n", vo.getPrice(), vo.getAccount(),
				vo.getBank(), vo.getMileage());
		System.out.println("");
	}
...
//나의 정보 보기
	public boolean printMypage() throws Exception {
		List<MypageVO> list = mypageController.printMypage(id);
		System.out.println("---------------------------------------");
		System.out.printf("아이디\t\t: %s\n---------------------------------------\n", list.get(0).getMemId());
		System.out.printf("이름\t\t: %s\n---------------------------------------\n", list.get(0).getMemName());
		System.out.printf("생년월일\t: %s\n---------------------------------------\n", list.get(0).getMemBir());
		System.out.printf("계좌번호\t: %s\n---------------------------------------\n", list.get(0).getAccount());
		System.out.printf("은행\t\t: %s\n---------------------------------------\n", list.get(0).getBank());
		System.out.printf("마일리지\t: %s\n---------------------------------------\n", list.get(0).getMileage());
		System.out.println("");			
